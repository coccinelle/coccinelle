...
type assignOpinfo = Ast.meta_name * Ast_cocci.assignOpconstraint * Ast0.pure * Data.clt
type binaryOpinfo = Ast.meta_name * Ast_cocci.binaryOpconstraint * Ast0.pure * Data.clt
