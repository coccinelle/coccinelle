...
type 'n combiner_rec_functions = {
  ...
  combiner_rec_initialiser_list : (Ast0.initialiser_list, 'n) combiner_inout;
  ...
  combiner_rec_statement_dots : (Ast0.statement Ast0.dots, 'n) combiner_inout;
  combiner_rec_declaration_dots :
    (Ast0.declaration Ast0.dots, 'n) combiner_inout;
  combiner_rec_field_dots : (Ast0.field Ast0.dots, 'n) combiner_inout;
  combiner_rec_case_line_dots : (Ast0.case_line Ast0.dots, 'n) combiner_inout;
...
type rebuilder_rec_functions = {
  ...
  rebuilder_rec_initialiser_list : Ast0.initialiser_list rebuilder_inout;
  ...
  rebuilder_rec_expression_dots : Ast0.expression Ast0.dots rebuilder_inout;
  rebuilder_rec_statement_dots : Ast0.statement Ast0.dots rebuilder_inout;
  rebuilder_rec_declaration_dots : Ast0.declaration Ast0.dots rebuilder_inout;
  rebuilder_rec_field_dots : Ast0.field Ast0.dots rebuilder_inout;
  rebuilder_rec_case_line_dots : Ast0.case_line Ast0.dots rebuilder_inout;
