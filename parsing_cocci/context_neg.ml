...
let equal_attribute a1 a2 =
  ...
  | (Ast0.CxxAttribute(lb11,arg1,rb11,rb21),
     Ast0.CxxAttribute(lb12,arg2,rb12,rb22)) ->
      equal_mcode lb11 lb12 && equal_mcode rb11 rb12 && equal_mcode rb21 rb22
  | (Ast0.CxxAttributeUsing(lb11,usng1,atnm1,dotdot1,arg1,rb11,rb21),
     Ast0.CxxAttributeUsing(lb12,usng2,atnm2,dotdot2,arg2,rb12,rb22)) ->
      equal_mcode lb11 lb12 && equal_mcode usng1 usng2 &&
      equal_mcode dotdot1 dotdot2 && equal_mcode rb11 rb12 &&
      equal_mcode rb21 rb22
  | _ -> false
...
let rec equal_expression e1 e2 =
  ...
  | (Ast0.Constructor(lp1,_,rp1,_),Ast0.Constructor(lp2,_,rp2,_)) ->
      equal_mcode lp1 lp2 && equal_mcode rp1 rp2
  | (Ast0.TupleExpr(_),Ast0.TupleExpr(_)) -> true
...
let equal_typeC t1 t2 =
  match (Ast0.unwrap t1,Ast0.unwrap t2) with
	...
	List.fold_left
      ...
      List.for_all2 equal_mcode cva cvb &&
      List.for_all2 equal_attribute attra attrb
...
let equal_declaration d1 d2 =
  ...
  | (Ast0.MacroDecl(stg1,preattr1,nm1,lp1,_,rp1,attr1,sem1),
     Ast0.MacroDecl(stg2,preattr2,nm2,lp2,_,rp2,attr2,sem2)) ->
       equal_option stg1 stg2 &&
       (List.length preattr1) = (List.length preattr2) &&
       List.for_all2 equal_attribute preattr1 preattr2 &&
  ...
  | (Ast0.MacroDeclInit(stg1,preattr1,nm1,lp1,_,rp1,attr1,eq1,_,sem1),
     Ast0.MacroDeclInit(stg2,preattr2,nm2,lp2,_,rp2,attr2,eq2,_,sem2)) ->
       equal_option stg1 stg2 &&
       (List.length preattr1) = (List.length preattr2) &&
       List.for_all2 equal_attribute preattr1 preattr2 &&
       (List.length attr1) = (List.length attr2) &&
...
let equal_field d1 d2 =
  ...
  | (Ast0.AccSpec(decl1,dd1), Ast0.AccSpec(decl2,dd2)) ->
...
let equal_statement s1 s2 =
  ...
  | (Ast0.Do(d1,_,whl1,lp1,_,rp1,sem1),Ast0.Do(d2,_,whl2,lp2,_,rp2,sem2)) ->
      ...
      equal_mcode lp1 lp2 && equal_mcode rp1 rp2 && equal_mcode sem1 sem2
  | (Ast0.ScopedGuard(sg1,lp1,_,rp1,_,_),Ast0.ScopedGuard(sg2,lp2,_,rp2,_,_)) ->
      equal_mcode sg1 sg2 && equal_mcode lp1 lp2 && equal_mcode rp1 rp2
...
let equal_define_param d1 d2 =
  ...
  | (Ast0.DParamEll _,Ast0.DParamEll _) -> true
