 ...
 *
 * $Id: corrected_saa5249.res,v 1.1 2007-03-18 20:09:51 julia Exp $
 *
 *	Derived From
 *
 * vtx.c:
...
static int saa5249_attach(struct i2c_adapter *adap, int addr, unsigned short flags, int kind)		
{
	...
	i2c_set_clientdata(client, vd=(struct video_device*)kmalloc(sizeof(struct video_device),GFP_KERNEL));
	if(vd==NULL)
	{
		kfree(t);
		kfree(client);
