...
/* $Id: corrected_applicom.res,v 1.1 2007-02-10 18:25:59 julia Exp $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: corrected_applicom.res,v 1.1 2007-02-10 18:25:59 julia Exp $\n");
...
{				/* @ ADG ou ATO selon le cas */
	...
	case 5:
		...
		break;
	case 6:
		printk(KERN_INFO "APPLICOM driver release .... V2.8.0 ($Revision: 1.1 $)\n");
