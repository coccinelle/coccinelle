...
static    __u64 ___arch__swab64(__u64 val)
{
        union {
                struct { __u32 a,b; } s;
                __u64 u;
...
static    __u32 __fswab32(__u32 x)
{
...
static    __u64 __fswab64(__u64 x)
{
                                      ...
                                      unsigned long new, int size)
{
        ...
        switch (size) {
        case 1:
                __asm__ ("" "cmpxchgb %b1,%2"
                                     : "=a"(prev)
                                     : "q"(new), "m"(*((struct __xchg_dummy *)(ptr))), "0"(old)
                                     : "memory");
                return prev;
        case 2:
                __asm__ ("" "cmpxchgw %w1,%2"
                                     : "=a"(prev)
                                     : "q"(new), "m"(*((struct __xchg_dummy *)(ptr))), "0"(old)
                                     : "memory");
                return prev;
        case 4:
                __asm__ ("" "cmpxchgl %1,%2"
                                     : "=a"(prev)
                                     : "q"(new), "m"(*((struct __xchg_dummy *)(ptr))), "0"(old)
                                     : "memory");
                return prev;
...
static  void detect_ht(struct cpuinfo_x86 *c) {}
...
static  void load_esp0(struct tss_struct *tss, struct thread_struct *thread)
{
        ...
        if (__builtin_expect(!!(tss->ss1 != thread->sysenter_cs), 0)) {
                ...
                __asm__ ("wrmsr" : : "c" (0x174), "a" (thread->sysenter_cs), "d" (0));
        }
}
...
extern  void prefetchw(const void *x)
{
...
static  void * __constant_memcpy(void * to, const void * from, size_t n)
{
        ...
        if (n >= 5*4) {
                ...
                if (n >= 4*4) __asm__ ("movsl"
                        :"=&D"(edi),"=&S"(esi):"0"(edi),"1"(esi):"memory");
                if (n >= 3*4) __asm__ ("movsl"
                        :"=&D"(edi),"=&S"(esi):"0"(edi),"1"(esi):"memory");
                if (n >= 2*4) __asm__ ("movsl"
                        :"=&D"(edi),"=&S"(esi):"0"(edi),"1"(esi):"memory");
                if (n >= 1*4) __asm__ ("movsl"
                        :"=&D"(edi),"=&S"(esi):"0"(edi),"1"(esi):"memory");
        }
        switch (n % 4) {

                case 0: return to;
                case 1: __asm__ ("movsb"
                        :"=&D"(edi),"=&S"(esi):"0"(edi),"1"(esi):"memory");
                        return to;
                case 2: __asm__ ("movsw"
                        :"=&D"(edi),"=&S"(esi):"0"(edi),"1"(esi):"memory");
                        return to;
                default: __asm__ ("movsw\n\tmovsb"
                        :"=&D"(edi),"=&S"(esi):"0"(edi),"1"(esi):"memory");
                        return to;
        }
}
...

{
        int d0, d1;
        switch (count % 4) {
                case 0: __asm__ ( "rep ; stosl" "" : "=&c" (d0), "=&D" (d1) : "a" (pattern),"0" (count/4),"1" ((long) s) : "memory"); return s;
                case 1: __asm__ ( "rep ; stosl" "\n\tstosb" : "=&c" (d0), "=&D" (d1) : "a" (pattern),"0" (count/4),"1" ((long) s) : "memory"); return s;
                case 2: __asm__ ( "rep ; stosl" "\n\tstosw" : "=&c" (d0), "=&D" (d1) : "a" (pattern),"0" (count/4),"1" ((long) s) : "memory"); return s;
                default: __asm__ ( "rep ; stosl" "\n\tstosw\n\tstosb" : "=&c" (d0), "=&D" (d1) : "a" (pattern),"0" (count/4),"1" ((long) s) : "memory"); return s;
        }
}
...
static  struct page *alloc_pages_node(int nid, unsigned int gfp_mask,
                                                unsigned int order)
{
...
static  void *kmalloc(size_t size, unsigned int flags)
{
...
static  void *kmalloc_node(size_t size, unsigned int flags, int node)
{
...
static  void *__alloc_percpu(size_t size, size_t align)
{
...
static  void free_percpu(const void *ptr)
{
        kfree(ptr);
}
...
{
        return ({ const int  *__mptr = (h); (struct kiocb *)( (char *)__mptr - ((size_t) &((struct kiocb *)0)->ki_list) );});
}
...
extern void wake_up_new_task(struct task_struct * tsk, unsigned long clone_flags)  ;
 ...
 static  void kick_process(struct task_struct *tsk) { }
...
static  int dequeue_signal_lock(struct task_struct *tsk, sigset_t *mask, siginfo_t *info)
{
        ...
        do { __asm__ ("pushfl ; popl %0 ; cli":"=g" (flags): :"memory"); do { } while (0); do { (void)(&tsk->sighand->siglock); } while(0); (void)0; } while (0);
        ret = dequeue_signal(tsk, mask, info);
        do { do { (void)(&tsk->sighand->siglock); } while(0); do { ({ unsigned long __dummy; int  __dummy2; (void)(&__dummy == &__dummy2); 1; }); __asm__ ("pushl %0 ; popfl": :"g" (flags):"memory", "cc"); } while (0); do { } while (0); (void)0; } while (0);
...
{
        return kobj ? ({ const int  *__mptr = (kobj); (struct kset *)( (char *)__mptr - ((size_t) &((struct kset *)0)->kobj) );}) : ((void *)0);
}
...
{
        return s ? ({ const int  *__mptr = (kset_get(&s->kset)); (struct subsystem *)( (char *)__mptr - ((size_t) &((struct subsystem *)0)->kset) );}) : ((void *)0);
}
...
{
        if (dentry) {
                do { if (__builtin_expect(!!((!((&dentry->d_count)->counter))!=0), 0)) __asm__ ( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (294), "i" ("include/linux/dcache.h")); } while(0);
...
static  void simple_transaction_set(struct file *file, size_t n)
{
        ...
        do { if (__builtin_expect(!!((n > ((1UL << 12) - sizeof(struct simple_transaction_argresp)))!=0), 0)) __asm__ ( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (1701), "i" ("include/linux/fs.h")); } while(0);
...
__acpi_acquire_global_lock (unsigned int *lock)
{
        ...
        do {
                ...
                val = ((*(lock) )__cmpxchg((lock),(unsigned long)(old), (unsigned long)(new),sizeof(*(lock))));
...
static  void disable_ioapic_setup(void)
{
        skip_ioapic_setup = 1;
}

static  int ioapic_setup_disabled(void)
{
        return skip_ioapic_setup;
}
# 156 "include/asm/acpi.h"
static  void acpi_noirq_set(void) { acpi_noirq = 1; }
...
{
        do { if (__builtin_expect(!!((vaddr >= ((unsigned long)0xfffff000) || vaddr < (((unsigned long)0xfffff000) - (__end_of_permanent_fixed_addresses << 12)))!=0), 0)) __asm__ ( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (153), "i" ("include/asm/fixmap.h")); } while(0);
...
static  pte_t pte_mkhuge(pte_t pte) { (pte).pte_low |= 0x001 | 0x080; return pte; }
...
static  int pud_none(pud_t pud) { return 0; }
static  int pud_bad(pud_t pud) { return 0; }
static  int pud_present(pud_t pud) { return 1; }
static  void pud_clear(pud_t *pud) { }
# 41 "include/asm-generic/pgtable-nopmd.h"
static  pmd_t * pmd_offset(pud_t * pud, unsigned long address)
{
        return (pmd_t *)pud;
}
...
# 359 "include/asm/pgtable.h"
 static  int set_kernel_exec(unsigned long vaddr, int enable) { return 0;}
...
{
        if (!(__builtin_constant_p(10) ? constant_test_bit((10),(&(page)->flags)) : variable_test_bit((10),(&(page)->flags))) && ({ do { if (__builtin_expect(!!(((((&(page)->_count)->counter) + 1) == 0)!=0), 0)) __asm__ ( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (340), "i" ("include/linux/mm.h")); } while(0); atomic_add_negative(-1, &(page)->_count); }))
...
extern pud_t *__pud_alloc(struct mm_struct *mm, pgd_t *pgd, unsigned long address)  ;
extern pmd_t *__pmd_alloc(struct mm_struct *mm, pud_t *pud, unsigned long address)  ;
...
static  int check_region(unsigned long s, unsigned long n)
{
...
{
        __asm__  ("lock; addl $0,0(%%esp)": : :"memory");
}
...
static  void outb_local(unsigned char value, int port) { __asm__ ("out" "b" " %" "b" "0, %w1" : : "a"(value), "Nd"(port)); } static  unsigned char inb_local(int port) { unsigned char value; __asm__ ("in" "b" " %w1, %" "b" "0" : "=a"(value) : "Nd"(port)); return value; } static  void outb_local_p(unsigned char value, int port) { outb_local(value, port); slow_down_io(); } static  unsigned char inb_local_p(int port) { unsigned char value = inb_local(port); slow_down_io(); return value; } static  void outb(unsigned char value, int port) { outb_local(value, port); } static  unsigned char inb(int port) { return inb_local(port); } static  void outb_p(unsigned char value, int port) { outb(value, port); slow_down_io(); } static  unsigned char inb_p(int port) { unsigned char value = inb(port); slow_down_io(); return value; } static  void outsb(int port, const void *addr, unsigned long count) { __asm__ ("rep; outs" "b" : "+S"(addr), "+c"(count) : "d"(port)); } static  void insb(int port, void *addr, unsigned long count) { __asm__ ("rep; ins" "b" : "+D"(addr), "+c"(count) : "d"(port)); }
static  void outw_local(unsigned short value, int port) { __asm__ ("out" "w" " %" "w" "0, %w1" : : "a"(value), "Nd"(port)); } static  unsigned short inw_local(int port) { unsigned short value; __asm__ ("in" "w" " %w1, %" "w" "0" : "=a"(value) : "Nd"(port)); return value; } static  void outw_local_p(unsigned short value, int port) { outw_local(value, port); slow_down_io(); } static  unsigned short inw_local_p(int port) { unsigned short value = inw_local(port); slow_down_io(); return value; } static  void outw(unsigned short value, int port) { outw_local(value, port); } static  unsigned short inw(int port) { return inw_local(port); } static  void outw_p(unsigned short value, int port) { outw(value, port); slow_down_io(); } static  unsigned short inw_p(int port) { unsigned short value = inw(port); slow_down_io(); return value; } static  void outsw(int port, const void *addr, unsigned long count) { __asm__ ("rep; outs" "w" : "+S"(addr), "+c"(count) : "d"(port)); } static  void insw(int port, void *addr, unsigned long count) { __asm__ ("rep; ins" "w" : "+D"(addr), "+c"(count) : "d"(port)); }
static  void outl_local(unsigned int value, int port) { __asm__ ("out" "l" " %" "" "0, %w1" : : "a"(value), "Nd"(port)); } static  unsigned int inl_local(int port) { unsigned int value; __asm__ ("in" "l" " %w1, %" "" "0" : "=a"(value) : "Nd"(port)); return value; } static  void outl_local_p(unsigned int value, int port) { outl_local(value, port); slow_down_io(); } static  unsigned int inl_local_p(int port) { unsigned int value = inl_local(port); slow_down_io(); return value; } static  void outl(unsigned int value, int port) { outl_local(value, port); } static  unsigned int inl(int port) { return inl_local(port); } static  void outl_p(unsigned int value, int port) { outl(value, port); slow_down_io(); } static  unsigned int inl_p(int port) { unsigned int value = inl(port); slow_down_io(); return value; } static  void outsl(int port, const void *addr, unsigned long count) { __asm__ ("rep; outs" "l" : "+S"(addr), "+c"(count) : "d"(port)); } static  void insl(int port, void *addr, unsigned long count) { __asm__ ("rep; ins" "l" : "+D"(addr), "+c"(count) : "d"(port)); }
# 69 "drivers/cdrom/gscd.c" 2
# 1 "include/asm/uaccess.h" 1
# 104 "include/asm/uaccess.h"
static  int verify_area(int type, const void * addr, unsigned long size)
{
...
__copy_to_user_inatomic(void *to, const void *from, unsigned long n)
{
        if (__builtin_constant_p(n)) {
                ...
                switch (n) {
                case 1:
                        do { *((u8 *)to)  __pus_tmp = *(u8 *)from; ret = 0; if(__builtin_expect(!!(__copy_to_user_ll((u8 *)to, &__pus_tmp, 1) != 0), 0)) ret = 1; } while (0);
                        return ret;
                case 2:
                        do { *((u16 *)to)  __pus_tmp = *(u16 *)from; ret = 0; if(__builtin_expect(!!(__copy_to_user_ll((u16 *)to, &__pus_tmp, 2) != 0), 0)) ret = 2; } while (0);
                        return ret;
                case 4:
                        do { *((u32 *)to)  __pus_tmp = *(u32 *)from; ret = 0; if(__builtin_expect(!!(__copy_to_user_ll((u32 *)to, &__pus_tmp, 4) != 0), 0)) ret = 4; } while (0);
                        return ret;
                }
        }
...
__copy_from_user_inatomic(void *to, const void *from, unsigned long n)
{
        if (__builtin_constant_p(n)) {
                ...
                switch (n) {
                case 1:
                        do { ret = 0; (void)0; switch (1) { case 1: __asm__ ( "1:	mov""b"" %2,%""b""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""b"" %""b""1,%""b""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=q" (*(u8 *)to) : "m"((*(struct __large_struct *)(from))), "i"(1), "0"(ret));break; case 2: __asm__ ( "1:	mov""w"" %2,%""w""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""w"" %""w""1,%""w""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=r" (*(u8 *)to) : "m"((*(struct __large_struct *)(from))), "i"(1), "0"(ret));break; case 4: __asm__ ( "1:	mov""l"" %2,%""""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""l"" %""""1,%""""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=r" (*(u8 *)to) : "m"((*(struct __large_struct *)(from))), "i"(1), "0"(ret));break; default: (*(u8 *)to) = __get_user_bad(); } } while (0);
                        return ret;
                case 2:
                        do { ret = 0; (void)0; switch (2) { case 1: __asm__ ( "1:	mov""b"" %2,%""b""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""b"" %""b""1,%""b""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=q" (*(u16 *)to) : "m"((*(struct __large_struct *)(from))), "i"(2), "0"(ret));break; case 2: __asm__ ( "1:	mov""w"" %2,%""w""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""w"" %""w""1,%""w""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=r" (*(u16 *)to) : "m"((*(struct __large_struct *)(from))), "i"(2), "0"(ret));break; case 4: __asm__ ( "1:	mov""l"" %2,%""""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""l"" %""""1,%""""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=r" (*(u16 *)to) : "m"((*(struct __large_struct *)(from))), "i"(2), "0"(ret));break; default: (*(u16 *)to) = __get_user_bad(); } } while (0);
                        return ret;
                case 4:
                        do { ret = 0; (void)0; switch (4) { case 1: __asm__ ( "1:	mov""b"" %2,%""b""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""b"" %""b""1,%""b""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=q" (*(u32 *)to) : "m"((*(struct __large_struct *)(from))), "i"(4), "0"(ret));break; case 2: __asm__ ( "1:	mov""w"" %2,%""w""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""w"" %""w""1,%""w""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=r" (*(u32 *)to) : "m"((*(struct __large_struct *)(from))), "i"(4), "0"(ret));break; case 4: __asm__ ( "1:	mov""l"" %2,%""""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""l"" %""""1,%""""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(ret), "=r" (*(u32 *)to) : "m"((*(struct __large_struct *)(from))), "i"(4), "0"(ret));break; default: (*(u32 *)to) = __get_user_bad(); } } while (0);
                        return ret;
                }
        }
...
static  void disk_stat_set_all(struct gendisk *gendiskp, int value) {
...
static  int init_disk_stats(struct gendisk *disk)
{
        return 1;
}

static  void free_disk_stats(struct gendisk *disk)
{
}
...
static  sector_t get_start_sect(struct block_device *bdev)
{
...
static  struct block_device *bdget_disk(struct gendisk *disk, int index)
{
...
static  unsigned int nr_free_highpages(void) { return 0; }
...
static  void memclear_highpage_flush(struct page *page, unsigned int offset, unsigned int size)
{
        ...
        do { if (__builtin_expect(!!((offset + size > (1UL << 12))!=0), 0)) __asm__ ( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (73), "i" ("include/linux/highmem.h")); } while(0);
...
static  unsigned int mapping_gfp_mask(struct address_space * mapping)
{
...
static  void mapping_set_gfp_mask(struct address_space *m, int mask)
{
...
static  struct page *page_cache_alloc(struct address_space *x)
{
        return alloc_pages_node(((0)), mapping_gfp_mask(x)|0x20000u, 0);
}

static  struct page *page_cache_alloc_cold(struct address_space *x)
{
...
static  struct page *grab_cache_page(struct address_space *mapping, unsigned long index)
{
...
static  void pagecache_acct(int count)
{
        atomic_add(count, &nr_pagecache);
}


static  unsigned long get_page_cache_size(void)
{
...
static  unsigned long linear_page_index(struct vm_area_struct *vma,
                                        unsigned long address)
{
...
static  void wait_on_page_locked(struct page *page)
{
...
static  void wait_on_page_writeback(struct page *page)
{
...
static  int fault_in_pages_writeable(char *uaddr, int size)
{
        int ret;
        ...
        ret = ({ long __pu_err; do { *(((uaddr)))  __pus_tmp = ((*(uaddr) )(0)); __pu_err = 0; if(__builtin_expect(!!(__copy_to_user_ll(((uaddr)), &__pus_tmp, (sizeof(*(uaddr)))) != 0), 0)) __pu_err = -14; } while (0); __pu_err; });
        if (ret == 0) {
                ...
                if (((unsigned long)uaddr & (~((1UL << 12)-1))) !=
                        ...
                        ret = ({ long __pu_err; do { *(((end)))  __pus_tmp = ((*(end) )(0)); __pu_err = 0; if(__builtin_expect(!!(__copy_to_user_ll(((end)), &__pus_tmp, (sizeof(*(end)))) != 0), 0)) __pu_err = -14; } while (0); __pu_err; });
        }
        return ret;
}
...
static  void fault_in_pages_readable(const char *uaddr, int size)
{
        ...
        ret = ({ long __gu_err; unsigned long __gu_val; do { __gu_err = 0; (void)0; switch ((sizeof(*(uaddr)))) { case 1: __asm__ ( "1:	mov""b"" %2,%""b""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""b"" %""b""1,%""b""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(__gu_err), "=q" (__gu_val) : "m"((*(struct __large_struct *)(((uaddr))))), "i"(-14), "0"(__gu_err));break; case 2: __asm__ ( "1:	mov""w"" %2,%""w""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""w"" %""w""1,%""w""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(__gu_err), "=r" (__gu_val) : "m"((*(struct __large_struct *)(((uaddr))))), "i"(-14), "0"(__gu_err));break; case 4: __asm__ ( "1:	mov""l"" %2,%""""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""l"" %""""1,%""""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(__gu_err), "=r" (__gu_val) : "m"((*(struct __large_struct *)(((uaddr))))), "i"(-14), "0"(__gu_err));break; default: (__gu_val) = __get_user_bad(); } } while (0); ((c)) = (*((uaddr)) )__gu_val; __gu_err; });
        if (ret == 0) {
                const char *end = uaddr + size - 1;

                if (((unsigned long)uaddr & (~((1UL << 12)-1))) !=
                                ((unsigned long)end & (~((1UL << 12)-1))))
                        ({ long __gu_err; unsigned long __gu_val; do { __gu_err = 0; (void)0; switch ((sizeof(*(end)))) { case 1: __asm__ ( "1:	mov""b"" %2,%""b""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""b"" %""b""1,%""b""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(__gu_err), "=q" (__gu_val) : "m"((*(struct __large_struct *)(((end))))), "i"(-14), "0"(__gu_err));break; case 2: __asm__ ( "1:	mov""w"" %2,%""w""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""w"" %""w""1,%""w""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(__gu_err), "=r" (__gu_val) : "m"((*(struct __large_struct *)(((end))))), "i"(-14), "0"(__gu_err));break; case 4: __asm__ ( "1:	mov""l"" %2,%""""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	movl %3,%0\n" "	xor""l"" %""""1,%""""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 4\n" "	.long 1b,3b\n" ".previous" : "=r"(__gu_err), "=r" (__gu_val) : "m"((*(struct __large_struct *)(((end))))), "i"(-14), "0"(__gu_err));break; default: (__gu_val) = __get_user_bad(); } } while (0); ((c)) = (*((end)) )__gu_val; __gu_err; });
        }
}
...
static  int bdi_read_congested(struct backing_dev_info *bdi)
{
        return bdi_congested(bdi, 1 << BDI_read_congested);
}

static  int bdi_write_congested(struct backing_dev_info *bdi)
{
        return bdi_congested(bdi, 1 << BDI_write_congested);
}

static  int bdi_rw_congested(struct backing_dev_info *bdi)
{
        return bdi_congested(bdi, (1 << BDI_read_congested)|
...
static  int task_ioprio(struct task_struct *task)
{
...
static  int task_nice_ioprio(struct task_struct *task)
{
...
static  int ioprio_best(unsigned short aprio, unsigned short bprio)
{
        ...
        if (aclass == bclass)
                return ({ int  _x = (aprio); int  _y = (bprio); (void) (&_x == &_y); _x < _y ? _x : _y; });
        if (aclass > bclass)
                return bprio;
        else
                return aprio;
...
extern  char *__bio_kmap_irq(struct bio *bio, unsigned short idx,
                                   unsigned long *flags)
{
...
static  int blk_queue_full(struct request_queue *q, int rw)
{
        if (rw == 0)
...
static  void blk_set_queue_full(struct request_queue *q, int rw)
{
        if (rw == 0)
...
static  void blk_clear_queue_full(struct request_queue *q, int rw)
{
        if (rw == 0)
...
static  request_queue_t *bdev_get_queue(struct block_device *bdev)
{
        return bdev->bd_disk->queue;
}

static  void blk_run_backing_dev(struct backing_dev_info *bdi,
                                       struct page *page)
{
...
static  void blk_run_address_space(struct address_space *mapping)
{
        if (mapping)
...
static  void blkdev_dequeue_request(struct request *req)
{
        do { if (__builtin_expect(!!((list_empty(&req->queuelist))!=0), 0)) __asm__ ( "ud2\n" "\t.word %c0\n" "\t.long %c1\n" : : "i" (612), "i" ("include/linux/blkdev.h")); } while(0);
...
static  int queue_hardsect_size(request_queue_t *q)
{
        int retval = 512;
...
static  int bdev_hardsect_size(struct block_device *bdev)
{
        return queue_hardsect_size(bdev_get_queue(bdev));
}

static  int queue_dma_alignment(request_queue_t *q)
{
        int retval = 511;
...
static  int bdev_dma_aligment(struct block_device *bdev)
{
...
extern  unsigned int block_size(struct block_device *bdev)
{
...
static  void put_dev_sector(Sector p)
{
        put_page(p.v);
}
...
static  short *__check_gscd(void) { return(&(gscd_port)); }; static char __param_str_gscd[] = "gscd"; static struct kernel_param const __param_gscd     = { __param_str_gscd, 0, param_set_short, param_get_short, &gscd_port }; static const char __mod_gscdtype80[]     = "parmtype" "=" "gscd" ":" "short";
...
static void   init_cd_drive(int num)
{
        char resp[50];
        int i;
...
static  initcall_t __inittest(void) { return gscd_init; } int init_module(void)  ;
static  exitcall_t __exittest(void) { return gscd_exit; } void cleanup_module(void)  ;
