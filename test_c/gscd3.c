...
static  int dequeue_signal_lock(struct task_struct *tsk, sigset_t *mask, siginfo_t *info)
{
        ...
        do { do { (void)(&tsk->sighand->siglock); } while(0); do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); __asm__ ("pushl %0 ; popfl": :"g" (flags):"memory", "cc"); } while (0); do { } while (0); (void)0; } while (0);
