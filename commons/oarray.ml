...
class ['a] oarray n el = 
  object(o: 'o)
    ...
    method add (i,v)  = (Array.set data i v; o)
    method iter f = Array.iteri (curry f) data
    method view = raise Todo

    method assoc i = Array.get data i
    ...
    method length = Array.length data

    method create: int -> 'a -> 'o = raise Todo
