...
testparsing2: 
	./spatch.opt -filter_define_error -D standard.h -dir -parse_c ~/kernels/git/linux-2.6/sound/ > /tmp/parse_sound_filter 2>&1 
	./spatch.opt -filter_define_error -D standard.h -dir -parse_c ~/kernels/git/linux-2.6/drivers/  > /tmp/parse_drivers_filter 2>&1 
