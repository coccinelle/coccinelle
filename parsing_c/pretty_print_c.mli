...
val pp_base_type_gen :
    pr_elem_func -> 
    Ast_c.fullType -> (Ast_c.storage * Ast_c.il) option -> unit
val pp_type_with_ident_rest_gen :
    pr_elem_func -> 
    (string * Ast_c.info) option -> Ast_c.fullType -> unit
val pp_type_left_gen : pr_elem_func -> Ast_c.fullType -> unit
val pp_type_right_gen : pr_elem_func -> Ast_c.fullType -> unit
