...
\rare{-control\_flow\_to\_file $\langle$file$\rangle$, -control\_flow\_to\_file
$\langle$file$\rangle$:$\langle$function$\rangle$}{ Like -control\_flow but
  just puts the dot output in a file.  For file.c, this produces file.dot.}
