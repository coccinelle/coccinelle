...
%  \CASE{error \NT{pmid\_with\_not\_eq\_list} ; }
  ...
  \CASE{\NT{id} \OPT{ = \mth{\{}\NT{COMMA\_LIST}\mth{(}\NT{assign\_op}\mth{)}\mth{\}}}}

  \RULE{\rt{binopdecl}}
  \CASE{\NT{id} \OPT{ = \mth{\{}\NT{COMMA\_LIST}\mth{(}\NT{bin\_op}\mth{)}\mth{\}}}}
...
\begin{grammar}
  ...
  \CASE{\NT{exp} \NT{meta\_assign\_op} \NT{exp}}
  \CASE{\NT{exp}++}
  \CASE{\NT{exp}--}
  \CASE{\NT{unary\_op} \NT{exp}}
  \CASE{\NT{exp} \NT{bin\_op} \NT{exp}}
  \CASE{\NT{exp} \NT{meta\_bin\_op} \NT{exp}}
