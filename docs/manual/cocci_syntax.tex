...
being declared is also referenced by its name.  An example is in
demos/parcon.cocci.

A declaration of a name as a typedef extends through the rest of the
semantic patch.  It is not required, and it will cause a parse error, to
redeclare a name as a typedef.
