...
Each element of a disjonction must been a proper term like an
expression, a statement, an identifier or a declaration. It means the
following left rule is not a syntaxically correct SmPL rule. One may
