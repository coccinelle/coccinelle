...
%  \CASE{ \opt{pure} \opt{context} \NT{metakind} \T{id} \ANY{, \T{id}} ;}
\begin{grammar}
  \RULE{metadecl}
  \CASE{\NT{arity} \NT{purity} fresh identifier comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} parameter comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} parameter list comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} expression list comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} type comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} statement comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} statement list comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} typedef comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} declarer name comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} iterator name comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{purity} identifier comma\_list(ident\_with\_not\_eq(not\_eq)) ;}
  \CASE{\NT{arity} \NT{purity} function comma\_list(ident\_with\_not\_eq(not\_eq)) ;}
  \CASE{\NT{arity} \NT{purity} local function comma\_list(ident\_with\_not\_eq(not\_eq)) ;}
  \CASE{\NT{arity} \NT{purity} declarer comma\_list(ident\_with\_not\_eq(not\_eq)) ;}
  \CASE{\NT{arity} \NT{purity} iterator comma\_list(ident\_with\_not\_eq(not\_eq)) ;}
  \CASE{\NT{arity} \NT{purity} error comma\_list(ident\_with\_not\_eq(not\_eqe)) ; }
  \CASE{\NT{arity} \NT{purity} \opt{local} idexpression \opt{ctype} comma\_list(ident\_with\_not\_eq(not\_eqe)) ;}
  \CASE{\NT{arity} \NT{purity} \opt{local} idexpression \OPT{\ttlb comma\_list(ctype) \ttrb list(*)} comma\_list(ident\_with\_not\_eq(not\_eqe)) ;}
  \CASE{\NT{arity} \NT{purity} \opt{local} idexpression nonempty\_list(*) comma\_list(ident\_with\_not\_eq(not\_eqe)) ;}
  \CASE{\NT{arity} \NT{purity} expression nonempty\_list(*) comma\_list(ident\_with\_not\_eq(not\_eqe)) ;}
  \CASE{\NT{arity} \NT{purity} ctype [ ] comma\_list(ident\_with\_not\_eq(not\_eqe)) ;}
  \CASE{\NT{arity} \NT{purity} \ttlb comma\_list(ctype) \ttrb list(*) [ ] comma\_list(ident\_with\_not\_eq(not\_eqe)) ;}
  \CASE{\NT{arity} \NT{purity} constant \opt{ctype} comma\_list(ident\_with\_not\_eq(not\_eqe)) ;}
  \CASE{\NT{arity} \NT{purity} constant \OPT{\ttlb comma\_list(ctype) \ttrb list(*)} comma\_list(ident\_with\_not\_eq(not\_eqe)) ;}
  \CASE{\NT{arity} \NT{purity} expression comma\_list(ident\_with\_not\_eq(not\_ceq)) ;}
  \CASE{\NT{arity} \NT{purity} ctype comma\_list(ident\_with\_not\_eq(not\_ceq)) ;}
  \CASE{\NT{arity} \NT{purity} \ttlb comma\_list(ctype) \ttrb list(*) comma\_list(ident\_with\_not\_eq(not\_ceq)) ;}
  \CASE{\NT{arity} position \opt{any} comma\_list(ident\_with\_not\_eq(not\_pos)) ;}
  \CASE{\NT{arity} \NT{pure} parameter list [ ident ] comma\_list(ident) ;}
  \CASE{\NT{arity} \NT{pure} expression list [ ident ] comma\_list(ident) ;}

  \RULE{arity}\CASE{\OPT{! \OR ? \OR +}}
  \RULE{purity}\CASE{\opt{pure} \opt{context}}
