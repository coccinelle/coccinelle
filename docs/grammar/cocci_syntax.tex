...
\begin{grammar}
  ...
  \CASE{\NT{arity} \NT{purity} \opt{local} idexpression \opt{ctype} \NT{pmid\_with\_not\_eq\_list} ;}
  \CASE{\NT{arity} \NT{purity} \opt{local} idexpression \OPT{\ttlb \NT{ctypes} \ttrb list(*)} \NT{pmid\_with\_not\_eq\_list} ;}
  ...
  \CASE{\NT{arity} \NT{purity} ctype [ ] \NT{pmid\_with\_not\_eq\_list} ;}
  \CASE{\NT{arity} \NT{purity} \ttlb \NT{ctypes} \ttrb \any{*} [ ] \NT{pmid\_with\_not\_eq\_list} ;}
  \CASE{\NT{arity} \NT{purity} constant \opt{ctype} \NT{pmid\_with\_not\_eq\_list} ;}
  ...
  \CASE{\NT{arity} \NT{purity} ctype \NT{pmid\_with\_not\_ceq\_list} ;}
  \CASE{\NT{arity} \NT{purity} \ttlb ctypes \ttrb \any{*} \NT{pmid\_with\_not\_ceq\_list} ;}
