...
\lstset{basicstyle=\ttfamily,numbers=left, numberstyle=\tiny, stepnumber=1, numbersep=5pt,language=C,commentstyle=\color{BrickRed},keywordstyle=\color{blue},stringstyle=\color{OliveGreen}}
...
\begin{grammar}
  ...
  \CASE{\ttlb~\opt{\NT{stmt\_sequence}} \ttrb}
