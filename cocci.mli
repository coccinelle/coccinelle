...
val sp_from_file : Common.filename -> Common.filename option -> Ast_cocci.rule list
val spbis_from_file : Common.filename -> Common.filename option -> Ast_cocci.rule_with_metavars list
val rule_elem_from_string : string -> Common.filename option -> Ast_cocci.rule_elem
