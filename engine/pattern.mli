...
val match_re_decl : (Ast_cocci.rule_elem, Ast_c.declaration)   matcher
...
val match_params :
  sequence_processing_style ->
  (Ast_cocci.parameterTypeDef list, (Ast_c.parameterTypeDef * Ast_c.il) list) matcher
...
val match_opt :
  ...
  Ast_c.exprStatement -> Ast_c.metavars_binding -> Ast_c.metavars_binding list
